...
class Coches:
    ...
    """
    def get_info(self):
        return f"Marca: {self.__marca}, Color: {self.__color}, Modelo: {self.__modelo}, Velocidad: {self.__velocidad}, Caballaje: {self.__caballaje}, Plazas: {self.__plazas}"
