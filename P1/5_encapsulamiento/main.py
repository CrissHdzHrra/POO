...
for i in range(0,num_coches):
    print(f"\n\t...Datos del Coche...{i+1}")
    marca=input(" marca del coche: ").upper()
    color=input(" color del coche: ").upper()
    modelo=input(" modelo del coche: ").upper()
    velocidad=int(input("maxima del coche: "))
    potencia=int(input("caballaje del coche: "))
    plazas=int(input(" numero de plazas del coche: "))
